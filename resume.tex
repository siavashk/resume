...
\section{Professional Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Frameworks}{Insight Toolkit (ITK), Qt, Tensorflow}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Neural Nerve Segmentation (in progress)}
          {Implemented a Django webapp for ultrasound annotation. Trained a U-Net model to predict nerve locations in ultrasound.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Data Collection and Processing}
          {Created data preprocessing, labelling, training and evaluation pipelines for training networks on images crawled from the interent.}
      \resumeItemListEnd
