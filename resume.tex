...
\section{Experience}
  \resumeSubHeadingListStart
  \resumeSubheading
    {Prenuvo}{Vancouver, BC}
    {Machine Learning Team Lead (team size 7)}{January 2021 - Present}
    
    \resumeItemListStart
      \resumeItem{Product Delievery}{Ownership of 10+ models at various stages of FDA regulatory approval.}
      \resumeItem{Hiring}{Conducted 50+ interviews to hire one machine learning engineering team lead, one program manager, three machine learning scientists and four interns.}
      \resumeItem{Management / Leadership}{Performed quarterly / milestone / sprint planning, JIRA board management and conducted 1:1s with team members.}
      \resumeItem{Communication}{Translate and ensure alignment of senior leadership goals / concerns as objective key results for individual contributors.}
      \resumeItem{Bottom-up Prodct Design}{Prepared requirements, roadmap and delivered mutliple products: organ-age, cricitcal condition detection and automatic report generation.}
      \resumeItem{Tooling / Process / Cultural Improvements}{Improved processes (CI/CD, code review, experiment management, best practices) for researchers to work as a team as opposed to independent scientists.}
      \resumeItem{Publications}{My team published 10+ abstracts at ISMRM and RSNA which is the premier radiology venue.}
    \resumeItemListEnd

  \resumeSubheading
    {Mesmer}{San Francisco, CA}
    {Machine Learning Engineer (Remote)}{August 2021 - December 2021}
    \resumeItemListStart
      \resumeItem{VCDOM Test Harness}{Created a test harness for measuring the precision/recall of the Vision Centric Document Object Model (VCDOM).}
      \resumeItem{Recall Improvements}{Improved recall on two categories from 0.07 to 0.61 and 0.84 to 0.90, respectively.}
      \resumeItem{Reason for Contract Termination}{The company was dissolved due to financial issues.}
    \resumeItemListEnd
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \educationSubheading
      ...
      {Logo Classification Using Neural Netwo rks}
  \resumeSubHeadingListEnd

\section{Github Open Source Projects}
  \resumeSubHeadingListStart
   \resumeSubItem{PyCPD (500 stars)}
