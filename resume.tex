...
\section{Experience}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Machine Learning Infrastructure}{Created a suitable infrastructure for training and deploying models to process 300 million images (25 million new images/month) on AWS. }
      \resumeItem{Improvements to an Existing Surface Model}{Improved the mean IoU from 95\% to 99\% for a semantic segmentation model by analysing failure cases and retraining with additional data.}
      \resumeItem{Unsupervised Learning}{Trained a Spatial VAE model to create a rotationally disentangled representation of downhole images for clustering purposes.}
    \resumeItemListEnd
...
\section{Github Open Source Projects}
  \resumeSubHeadingListStart
   ...
   \resumeSubItem{Gym-MNIST-Pair (hobby)}
     {OpenAI gym environment for reinforcement learning to find matching patches in affNist.}
  \resumeSubHeadingListEnd
