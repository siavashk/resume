...
\section{Experience}
  ...
  \resumeSubheading
    ...
    {Machine Learning Team Lead (team size 8)}{January 2022 - Present}
    
    \resumeItemListStart
      \resumeItem{Product Delivery}{Cleared a 510K submission for an AI-based SAMD (31 labels + 2 models) in 14 months.}
      \resumeItem{Product Delivery}{Ownership of 10+ models IDE and STEP FDA regulatory processes.}
      \resumeItem{Generation Modeling}{Extended diffusion denoising models from 2D to 3D T2 whole spine volumes.}
      \resumeItem{Vision Language Modeling}{Transformer-based automatic report generation from T2 Whole spine volumes.}
      \resumeItem{Semantic Segmentation}{Multiple nnUNet models for segmentation / volume measurements of organs in MR.}
      \resumeItem{Object Detection}{nnDetection based model for follicle counting in T2 MRI (female fertility).}
      \resumeItem{Regression}{Developed organ age estimation models for spine, prostate and uterus in T2 MRI.}
