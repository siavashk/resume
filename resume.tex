...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Machine Learning}
          {Automatic nerve segmentation in progress}
        \resumeItem{Image Processing}
          {Automatic follicle/bladder segmentation}
        \resumeItem{Software Development}
        {App development with C++11, boost, Qt, CMake, cross platform}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Image-based Content Retreival}
          {CNN for extracting and matching images}
        \resumeItem{Attentive Image Patch Matching}
          {Reinforcement learning agent for finding corresponding image patches in image pairs}
