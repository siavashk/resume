...
\section{Experience}
  ...
  \resumeSubheading
    ...
    {Machine Learning Team Lead}{January 2021 - Present}
    \resumeItemListStart
      \resumeItem{Leadership}{Leading a team of three machine learning scientists and a medical doctor to perform research.}
      \resumeItem{Publications}{Oversee the publication efforts in various team.}
      \resumeItem{Spine Project}{Machine learning product which segments and identifies pathologies in the spine from whole body MRI sequences.}
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      ...
      \resumeItem{Machine Learning to Identify Surfaces in a Tabular (patent pending)}{UNet++ semantic segmentation for finding pipe surfaces in ultrasound images.}
      \resumeItem{Automatic Perforation Erosion Measurement (patent in preparation)}{PointRend semantic segmentation for finding perforations in ultrasound images.}
    \resumeItemListEnd
