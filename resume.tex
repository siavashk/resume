...
\section{Professional Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Languages}{\textit{Experienced}: C++, Javascript, \textit{Familiar}: Python}
    \resumeSubItem{Frameworks}{\textit{Experienced}: Insight Toolkit (ITK), Qt, Node, \textit{Familiar}: Tensorflow}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Neural Nerve Segmentation (in progress)}
          {Designed a study to collect ultrasound nerve images for supervised\\learning. Designed and implemented annotation tools for manual segmentation. Created a syntethic dataset for simulating labelled data.}
        \resumeItem{Semiautomatic Ultrasound Segmentation}
...
\section{Education}
  \resumeSubHeadingListStart
    \educationSubheading
      {University of British Columboa}{Vancouver, BC}
...
\section{Honors and Awards}
  \resumeSubHeadingListStart
    ...
    \reviewItem{Winter olympics torch bearer, Queen's University, Kingston, ON, 2009}
  \resumeSubHeadingListEnd
